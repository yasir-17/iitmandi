...
function ra(a,b){a.h={Da:b,qa:!0};a.f=a.l||a.j}
...
function va(a){var b=a.u.splice(0)[0];(b=a.h=a.h||b)?b.qa?a.f=a.l||a.j:void 0!=b.F&&a.j<b.F?(a.f=b.F,a.h=null):a.f=a.j:a.f=0}
...
function za(a){for(;a.f.f;)try{var b=a.g(a.f);if(b)return a.f.m=!1,{value:b.value,done:!1}}catch(c){a.f.g=void 0,ra(a.f,c)}a.f.m=!1;if(a.f.h){b=a.f.h;a.f.h=null;if(b.qa)throw b.Da;return{value:b["return"],done:!0}}return{value:void 0,done:!0}}
...
tb.prototype.ja=!0;tb.prototype.ga=function(){return 1};
...
Pb.prototype.ja=!0;Pb.prototype.ga=function(){return this.g};
Pb.prototype.M=!0;Pb.prototype.L=function(){return this.f.toString()};
var Qb={};function Sb(a,b){var c=new Pb,d=sb();c.f=d?d.createHTML(a):a;c.g=b;return c}
;function Tb(a,b){var c=b instanceof H?b:Kb(b);a.href=Ib(c)}
...
return a}
var Lc={hb:"allow-forms",ib:"allow-modals",jb:"allow-orientation-lock",kb:"allow-pointer-lock",lb:"allow-popups",mb:"allow-popups-to-escape-sandbox",nb:"allow-presentation",ob:"allow-same-origin",pb:"allow-scripts",qb:"allow-top-navigation",rb:"allow-top-navigation-by-user-activation"},Nc=Ya(function(){return Mc()});
...
function b(q){for(var u=g,p=0;64>p;p+=4)u[p/4]=q[p]<<24|q[p+1]<<16|q[p+2]<<8|q[p+3];for(p=16;80>p;p++)q=u[p-3]^u[p-8]^u[p-14]^u[p-16],u[p]=(q<<1|q>>>31)&4294967295;q=e[0];var z=e[1],N=e[2],oa=e[3],cd=e[4];for(p=0;80>p;p++){if(40>p)if(20>p){var Oa=oa^z&(N^oa);var Rb=1518500249}else Oa=z^N^oa,Rb=1859775393;else 60>p?(Oa=z&N|oa&(z|N),Rb=2400959708):(Oa=z^N^oa,Rb=3395469782);Oa=((q<<5|q>>>27)&4294967295)+Oa+cd+Rb+u[p]&4294967295;cd=oa;oa=N;N=(z<<30|z>>>2)&4294967295;z=q;q=Oa}e[0]=e[0]+q&4294967295;e[1]=
e[1]+z&4294967295;e[2]=e[2]+N&4294967295;e[3]=e[3]+oa&4294967295;e[4]=e[4]+cd&4294967295}
...
for(var e=[],f=[],g=[],k=[128],h=1;64>h;++h)k[h]=0;var l,m;a();return{reset:a,update:c,digest:d,Ca:function(){for(var q=d(),u="",p=0;p<q.length;p++)u+="0123456789ABCDEF".charAt(Math.floor(q[p]/16))+"0123456789ABCDEF".charAt(q[p]%16);return u}}}
...
function Xc(a){var b=Vc();b.update(a);return b.Ca().toLowerCase()}
...
if("undefined"!==typeof a&&!I("Trident")&&!I("MSIE")){var b=new a,c={},d=c;b.port1.onmessage=function(){if(void 0!==c.next){c=c.next;var e=c.oa;c.oa=null;e()}};
...
!Ma(y.setImmediate)||y.Window&&y.Window.prototype&&!I("Edge")&&y.Window.prototype.setImmediate==y.setImmediate?(ed||(ed=fd()),ed(b)):y.setImmediate(b)}}
var md=!1,nd=new gd;function od(){for(var a;a=nd.remove();){try{a.f.call(a.scope)}catch(b){dd(b)}bd(id,a)}md=!1}
...
var ce=dd;function Ud(a){F.call(this,a)}
...
return Ie(a,f||{},!1)}
function Xe(a,b){if(window.fetch&&"XML"!=b.format){var c={method:b.method||"GET",credentials:"same-origin"};b.headers&&(c.headers=b.headers);a=Ye(a,b);var d=Ze(a,b);d&&(c.body=d);b.withCredentials&&(c.credentials="include");var e=!1,f;fetch(a,c).then(function(g){if(!e){e=!0;f&&V(f);var k=g.ok,h=function(l){l=l||{};var m=b.context||y;k?b.onSuccess&&b.onSuccess.call(m,l,g):b.onError&&b.onError.call(m,l,g);b.la&&b.la.call(m,l,g)};
"JSON"==(b.format||"JSON")&&(k||400<=g.status&&500>g.status)?g.json().then(h,function(){h(null)}):h(null)}});
b.va&&0<b.timeout&&(f=U(function(){e||(e=!0,V(f),b.va.call(b.context||y))},b.timeout))}else $e(a,b)}
function $e(a,b){var c=b.format||"JSON";a=Ye(a,b);var d=Ze(a,b),e=!1,f=af(a,function(h){if(!e){e=!0;k&&V(k);var l=Re(h),m=null,q=400<=h.status&&500>h.status,u=500<=h.status&&600>h.status;if(l||q||u)m=bf(a,c,h,b.vb);if(l)a:if(h&&204==h.status)l=!0;else{switch(c){case "XML":l=0==parseInt(m&&m.return_code,10);break a;case "RAW":l=!0;break a}l=!!m}m=m||{};q=b.context||y;l?b.onSuccess&&b.onSuccess.call(q,h,m):b.onError&&b.onError.call(q,h,m);b.la&&b.la.call(q,h,m)}},b.method,d,b.headers,b.responseType,
b.withCredentials);
if(b.R&&0<b.timeout){var g=b.R;var k=U(function(){e||(e=!0,f.abort(),V(k),g.call(b.context||y,f))},b.timeout)}return f}
function Ye(a,b){b.yb&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=R("XSRF_FIELD_NAME",void 0),d=b.gb;d&&(d[c]&&delete d[c],a=Ie(a,d||{},!0));return a}
function Ze(a,b){var c=R("XSRF_FIELD_NAME",void 0),d=R("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.D,g=R("XSRF_FIELD_NAME",void 0),k;b.headers&&(k=b.headers["Content-Type"]);b.xb||J(a)&&!b.withCredentials&&J(a)!=document.location.hostname||"POST"!=b.method||k&&"application/x-www-form-urlencoded"!=k||b.D&&b.D[g]||(f||(f={}),f[c]=d);f&&"string"===typeof e&&(e=He(e),qb(e,f),e=b.wa&&"JSON"==b.wa?JSON.stringify(e):$b(e));f=e||f&&!kb(f);!Ue&&f&&"POST"!=b.method&&(Ue=!0,S(Error("AJAX request with postData should use POST")));
return e}
...
return e}
function ef(a){if(Na(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d=Sb(a[b],null);a[c]=d}else ef(a[b])}}
...
return h}
;var ff={},gf=0;
function hf(a,b,c,d,e){e=void 0===e?"":e;a&&(c&&(c=Mb,c=!(c&&0<=c.toLowerCase().indexOf("cobalt"))),c?a&&(a instanceof H||(a="object"==typeof a&&a.M?a.L():String(a),a=Jb.test(a)?new H(Gb,a):null),b=Ib(a||Lb),"about:invalid#zClosurez"===b?a="":(b instanceof Pb?a=b:(d="object"==typeof b,a=null,d&&b.ja&&(a=b.ga()),b=yb(d&&b.M?b.L():String(b)),a=Sb(b,a)),a instanceof Pb&&a.constructor===Pb&&a.h===Qb?a=a.f:(Ka(a),a="type_error:SafeHtml"),a=encodeURIComponent(String(Fd(a.toString())))),/^[\s\xa0]*$/.test(a)||(a=
...
function ng(a,b,c,d){d=void 0===d?{}:d;var e={};e.eventTimeMs=Math.round(d.timestamp||W());e[a]=b;e.context={lastActivityMs:String(d.timestamp?-1:Hf())};T("log_sequence_info_on_gel_web")&&d.S&&(a=e.context,b=d.S,mg[b]=b in mg?mg[b]+1:0,a.sequence={index:mg[b],groupKey:b},d.wb&&delete mg[d.S]);d=d.fa;a="";d&&(a={},d.videoId?a.videoId=d.videoId:d.playlistId&&(a.playlistId=d.playlistId),dg[d.token]=a,a=d.token);d=cg.get(a)||[];cg.set(a,d);d.push(e);c&&(Xf=new c);c=Oe("web_logging_max_batch")||100;e=
...
function qg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||R("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.tb||R("AUTHORIZATION"))||(a?b="Bearer "+B("gapi.auth.getToken")().sb:b=Yc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=R("SESSION_INDEX",0),T("pageid_as_header_web")&&(d["X-Goog-PageId"]=R("DELEGATED_SESSION_ID")));return d}
...
;function tg(a,b,c,d){wc.set(""+a,b,{ra:c,path:"/",domain:void 0===d?"youtube.com":d,secure:!1})}
...
v(Bg,Error);function X(a){return new O(function(b,c){function d(){c(a.error);f()}
function e(){b(a.result);f()}
function f(){a.removeEventListener("success",e);a.removeEventListener("error",d)}
a.addEventListener("success",e);a.addEventListener("error",d)})}
;function Cg(a){this.f=a}
n=Cg.prototype;n.add=function(a,b,c){return Dg(Eg(this,[a],"readwrite"),a).add(b,c)};
n.clear=function(a){return Dg(Eg(this,[a],"readwrite"),a).clear()};
n.close=function(){this.f.close()};
n.count=function(a,b){return Dg(Eg(this,[a]),a).count(b)};
function Fg(a,b,c){a=a.f.createObjectStore(b,c);return new Gg(a)}
n["delete"]=function(a,b){return Dg(Eg(this,[a],"readwrite"),a)["delete"](b)};
n.get=function(a,b){return Dg(Eg(this,[a]),a).get(b)};
function Eg(a,b,c){a=a.f.transaction(b,c);return new Hg(a)}
function Gg(a){this.f=a}
n=Gg.prototype;n.add=function(a,b){return X(this.f.add(a,b))};
...
n.index=function(a){return new Ig(this.f.index(a))};
n.getName=function(){return this.f.name};
function Hg(a){var b=this;this.f=a;this.g=new Map;this.done=new O(function(c,d){b.f.addEventListener("complete",function(){c()});
b.f.addEventListener("error",function(){d(b.f.error)});
b.f.addEventListener("abort",function(){d(new Bg)})})}
Hg.prototype.abort=function(){this.f.abort();return this.done};
function Dg(a,b){var c=a.f.objectStore(b),d=a.g.get(c);d||(d=new Gg(c),a.g.set(c,d));return d}
function Ig(a){this.f=a}
Ig.prototype.count=function(a){return X(this.f.count(a))};
Ig.prototype.get=function(a){return X(this.f.get(a))};
function Jg(a,b){this.request=a;this.f=b}
function Kg(a){return X(a).then(function(b){return null===b?null:new Jg(a,b)})}
Jg.prototype["delete"]=function(){return X(this.f["delete"]()).then(function(){})};
Jg.prototype.getValue=function(){return this.f.value};
Jg.prototype.update=function(a){return X(this.f.update(a))};function Lg(a,b,c){function d(){m||(m=new Cg(f.result));return m}
var e=Hg;var f=void 0!==b?self.indexedDB.open(a,b):self.indexedDB.open(a);var g=c.f,k=c.blocking,h=c.g,l=c.upgrade,m;l&&f.addEventListener("upgradeneeded",function(q){if(null===q.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");if(null===f.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");var u=d(),p=new e(f.transaction);l(u,q.oldVersion,q.newVersion,p)});
g&&f.addEventListener("blocked",function(){g()});
return X(f).then(function(q){k&&q.addEventListener("versionchange",function(){k(d())});
h&&q.addEventListener("close",function(){h()});
return d()})}
function Mg(a,b,c){c=void 0===c?{}:c;return Lg(a,b,c)}
;var Ng;function Og(){return M(this,function b(){var c,d,e;return x(b,function(f){switch(f.f){case 1:if(!self.indexedDB)return f["return"](!1);sa(f);e=!1;return w(f,Mg("yt-idb-test-do-not-use",void 0,{blocking:function(){e=!0;c&&(c.close(),c=void 0)}}),5);
case 5:return c=f.g,w(f,Mg("yt-idb-test-do-not-use",c.f.version+1),6);case 6:return d=f.g,d.close(),d=void 0,f["return"](e);case 3:ua(f);if(c)try{c.close()}catch(g){}if(d)try{d.close()}catch(g){}va(f);break;case 2:return ta(f),f["return"](!1)}})})}
function Pg(){return void 0!==Ng?Qd(Ng):new O(function(a){Og().then(function(b){Ng=b;a(b)})})}
;var Qg;function Rg(){return M(this,function b(){return x(b,function(c){if(!Qg)try{Qg=Mg("LogsDataBase",1,{upgrade:function(d,e){1>e&&(Fg(d,"LogsRequestsStore",{keyPath:"id",autoIncrement:!0}).f.createIndex("newRequest",["status","authHash","timestamp"],{unique:!1}),Fg(d,"sapisid"))}})}catch(d){if(!(d instanceof DOMException||d instanceof DOMError)||"VersionError"!==d.name)return S(d),c["return"](Promise.reject(d));
Qg=Mg("LogsDataBase")}return c["return"](Qg)})})}
function Sg(a){return M(this,function c(){var d,e,f,g,k;return x(c,function(h){switch(h.f){case 1:return w(h,Rg(),2);case 2:return d=h.g,e=Dg(Eg(d,["LogsRequestsStore"],"readwrite"),"LogsRequestsStore"),w(h,Tg(),3);case 3:return f=h.g,g=Object.assign(Object.assign({},a),{options:JSON.parse(JSON.stringify(a.options)),authHash:f}),w(h,e.add(g),4);case 4:return k=h.g,h["return"](k)}})})}
function Ug(){return M(this,function b(){var c,d,e,f,g,k,h,l;return x(b,function(m){switch(m.f){case 1:return w(m,Tg(),2);case 2:return c=m.g,d=["NEW",c,0],e=["NEW",c,W()],f=IDBKeyRange.bound(d,e),w(m,Rg(),3);case 3:g=m.g;k=Eg(g,["LogsRequestsStore"],"readwrite");var q=Dg(k,"LogsRequestsStore").index("newRequest").f.openCursor(f,"prev");q=Kg(q);return w(m,q,4);case 4:h=m.g;l=void 0;if(null===h||void 0===h||!h.getValue()){m.F(5);break}l=h.getValue();l.status="QUEUED";return w(m,h.update(l),5);case 5:return m["return"](l)}})})}
function Vg(a){return M(this,function c(){var d,e,f;return x(c,function(g){switch(g.f){case 1:return w(g,Rg(),2);case 2:return d=g.g,e=Dg(Eg(d,["LogsRequestsStore"],"readwrite"),"LogsRequestsStore"),w(g,e.get(a),3);case 3:return f=g.g,f.status="QUEUED",w(g,X(e.f.put(f,void 0)),4);case 4:return g["return"](f)}})})}
function Wg(a){return M(this,function c(){var d,e,f;return x(c,function(g){switch(g.f){case 1:return w(g,Rg(),2);case 2:return d=g.g,e=Dg(Eg(d,["LogsRequestsStore"],"readwrite"),"LogsRequestsStore"),w(g,e.get(a),3);case 3:return f=g.g,f.status="NEW",f.sendCount+=1,w(g,X(e.f.put(f,void 0)),4);case 4:return g["return"](f)}})})}
function Xg(){return M(this,function b(){var c,d;return x(b,function(e){if(1==e.f)return w(e,Rg(),2);if(3!=e.f)return c=e.g,w(e,c.count("LogsRequestsStore"),3);d=e.g;return e["return"](!d)})})}
function Yg(a){return M(this,function c(){var d;return x(c,function(e){if(1==e.f)return w(e,Rg(),2);d=e.g;return e["return"](d["delete"]("LogsRequestsStore",a))})})}
function Tg(){return M(this,function b(){var c;return x(b,function(d){if(1==d.f){Ag.f||(Ag.f=new Ag);var e={};var f=Yc([]);f&&(e.Authorization=f,e["X-Goog-AuthUser"]=R("SESSION_INDEX",0),"INNERTUBE_HOST_OVERRIDE"in ve||(e["X-Origin"]=window.location.origin),T("pageid_as_header_web")&&"DELEGATED_SESSION_ID"in ve&&(e["X-Goog-PageId"]=R("DELEGATED_SESSION_ID")));e=Qd(e);return w(d,e,2)}c=d.g;return d["return"](sg(c))})})}
;var Zg=Oe("network_polling_interval",3E4);function $g(){this.i=0;this.f=window.navigator.onLine;ah(this);bh(this)}
function ch(){$g.f||($g.f=new $g);return $g.f}
function dh(a){var b=eh,c=fh;gh(a);(new O(function(d){a.g=d})).then(function(){b();
c&&(a.h=c)})}
function bh(a){window.addEventListener("online",function(){a.f=!0;a.g&&a.g()})}
function ah(a){window.addEventListener("offline",function(){a.f=!1;a.h&&a.h()})}
function gh(a){a.i||(hh(a),window.navigator.onLine&&a.g&&a.g())}
function hh(a){a.i=yf(function(){window.navigator.onLine?(!1===a.f&&S(Error("NetworkStatusManager missed online event.")),a.f=!0,a.g&&a.g()):(!0===a.f&&S(Error("NetworkStatusManager missed offline event.")),a.f=!1,a.h&&a.h());hh(a)},Zg)}
;var ih=Oe("networkless_throttle_timeout")||100,jh=Oe("networkless_retry_attempts")||1,kh=0;function lh(a,b){Pg().then(function(c){if(c&&!T("networkless_bypass_write")){var d={url:a,options:b,timestamp:W(),status:"NEW",sendCount:0};Sg(d).then(function(e){d.id=e;e=ch();e.f?mh(d):dh(e)})["catch"](function(){mh(d);
S(Error("Networkless Logging: Log request setting to indexedDB failed."))})}else $e(a,b)})}
function eh(){kh||(kh=Af(function(){mh();kh=0;eh()},ih))}
function fh(){Cf(kh);kh=0}
function mh(a){M(this,function c(){var d=this,e,f,g,k;return x(c,function(h){switch(h.f){case 1:e=d;if(!a)return w(h,Ug(),6);if(!a.id){h.F(3);break}return w(h,Vg(a.id),5);case 5:a=h.g;h.F(3);break;case 6:if(a=h.g){h.F(3);break}return w(h,Xg(),8);case 8:return(f=h.g)&&fh(),h["return"]();case 3:if(nh(a))g=a.options.onError?a.options.onError:function(){},k=a.options.onSuccess?a.options.onSuccess:function(){},a.options.onError=function(l,m){return M(e,function u(){return x(u,function(p){if(1==p.f)return a&&
a.id?a.sendCount<jh?w(p,Wg(a.id),6):w(p,Yg(a.id),2):p.F(2);
2!=p.f&&(kh||dh(ch()),g(l,m));g(l,m);p.f=0})})},a.options.onSuccess=function(l,m){return M(e,function u(){return x(u,function(p){if(1==p.f)return a&&a.id?w(p,Yg(a.id),2):p.F(2);
k(l,m);p.f=0})})},$e(a.url,a.options);
else if(Ee(Error("Networkless Logging: Stored logs request expired age limit")),a.id)return w(h,Yg(a.id),0);h.F(0)}})})}
function nh(a){a=a.timestamp;return 2592E6<=W()-a?!1:!0}
;function oh(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];d=Error.call(this,a);this.message=d.message;"stack"in d&&(this.stack=d.stack);this.args=[].concat(c instanceof Array?c:fa(t(c)))}
v(oh,Error);function ph(a){var b=this;this.f=null;a?this.f=a:pg()&&(this.f=ig());yf(function(){zg(b)},5E3)}
ph.prototype.isReady=function(){!this.f&&pg()&&(this.f=ig());return!!this.f};
function lg(a,b,c,d){!R("VISITOR_DATA")&&"visitor_id"!==b&&.01>Math.random()&&Ee(new oh("Missing VISITOR_DATA when sending innertube request.",b,c,d));if(!a.isReady())throw b=new oh("innertube xhrclient not ready",b,c,d),S(b),b.f=0,b;var e={headers:{"Content-Type":"application/json"},method:"POST",D:c,wa:"JSON",R:function(){d.R()},
va:d.R,onSuccess:function(p,z){if(d.onSuccess)d.onSuccess(z)},
ua:function(p){if(d.onSuccess)d.onSuccess(p)},
onError:function(p,z){if(d.onError)d.onError(z)},
zb:function(p){if(d.onError)d.onError(p)},
timeout:d.timeout,withCredentials:!0},f="",g=a.f.Na;g&&(f=g);g=a.f.Pa||!1;var k=qg(g,f,d);Object.assign(e.headers,k);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var h="/youtubei/"+a.f.innertubeApiVersion+"/"+b,l={alt:"json"};a.f.Oa&&e.headers.Authorization||(l.key=a.f.innertubeApiKey);h=Ie(""+f+h,l||{},!0);var m;if(d.retry&&T("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(m=xg(b,c,k,g))){var q=e.onSuccess,u=e.ua;e.onSuccess=function(p,z){yg(m);q(p,z)};
c.ua=function(p,z){yg(m);u(p,z)}}try{T("use_fetch_for_op_xhr")?Xe(h,e):T("networkless_logging")&&d.retry?(e.method="POST",lh(h,e)):(e.method="POST",e.D||(e.D={}),$e(h,e))}catch(p){if("InvalidAccessError"==p.name)m&&(yg(m),m=0),Ee(Error("An extension is blocking network request."));
else throw p;}m&&yf(function(){zg(a)},5E3)}
;function qh(a,b,c){c=void 0===c?{}:c;var d=ph;R("ytLoggingEventsDefaultDisabled",!1)&&ph==ph&&(d=null);ng(a,b,d,c)}
;var rh=[{sa:function(a){return"Cannot read property '"+a.key+"'"},
...
groups:["key"]}]}}];var sh=new Set,th=0;function uh(a){vh(a,"WARNING")}
...
window.yterr||f)&&!(5<=th)&&0!==a.f)){var g=tc(a);f=g.message||"Unknown Error";d=g.name||"UnknownError";e=g.lineNumber||"Not available";var k=g.fileName||"Not available";g=g.stack||a.g||"Not available";if(a.hasOwnProperty("args")&&a.args&&a.args.length)for(var h=0,l=0;l<a.args.length;l++){var m=a.args[l],q="params."+l;h+=q.length;if(m)if(Array.isArray(m))for(var u=c,p=0;p<m.length&&!(m[p]&&(h+=wh(p,m[p],q,u),500<h));p++);else if("object"===typeof m)for(u in u=void 0,p=c,m){if(m[u]&&(h+=wh(u,m[u],
...
isNaN(a)||(c.lineNumber=c.lineNumber+":"+a);a=t(rh);for(f=a.next();!f.done;f=a.next())if(f=f.value,f.ma[c.name])for(e=t(f.ma[c.name]),d=e.next();!d.done;d=e.next())if(k=d.value,d=c.message.match(k.regexp)){c.params["error.original"]=d[0];e=k.groups;k={};for(g=0;g<e.length;g++)k[e[g]]=d[g+1],c.params["error."+e[g]]=d[g+1];c.message=f.sa(k);break}window.yterr&&"function"===typeof window.yterr&&window.yterr(c);if(!(sh.has(c.message)||0<=c.stack.indexOf("/YouTubeCenter.js")||0<=c.stack.indexOf("/mytube.js"))){if(T("kevlar_gel_error_routing")){f=
...
kvPairs:[]};if(e=c.params)for(k=t(Object.keys(e)),g=k.next();!g.done;g=k.next())g=g.value,d.kvPairs.push({key:"client."+g,value:String(e[g])});qh("clientError",{errorMetadata:d,stackTrace:f,logMessage:a});eg()}a=c.params||{};b={gb:{a:"logerror",t:"jserror",type:c.name,msg:c.message.substr(0,250),line:c.lineNumber,level:b,"client.name":a.name},D:{url:R("PAGE_NAME",window.location.href),file:c.fileName},method:"POST"};a.version&&(b["client.version"]=a.version);if(b.D){c.stack&&(b.D.stack=c.stack);f=
t(Object.keys(a));for(d=f.next();!d.done;d=f.next())d=d.value,b.D["client."+d]=a[d];if(a=R("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(f=t(Object.keys(a)),d=f.next();!d.done;d=f.next())d=d.value,b.D[d]=a[d];a=R("SERVER_NAME",void 0);f=R("SERVER_VERSION",void 0);a&&f&&(b.D["server.name"]=a,b.D["server.version"]=f)}$e(R("ECATCHER_REPORT_HOST","")+"/error_204",b);sh.add(c.message);th++}}}
function wh(a,b,c,d){c+="."+a;a=String(JSON.stringify(b)).substr(0,500);d[c]=a;return c.length+a.length}
;function xh(a,b,c,d,e,f){vh(a,void 0===b?"ERROR":b,c,d,f)}
;var yh=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};A("yt.msgs_",yh,void 0);function zh(a){ue(yh,arguments)}
;function Ah(a){a&&(a.dataset?a.dataset[Bh("loaded")]="true":a.setAttribute("data-loaded","true"))}
function Ch(a,b){return a?a.dataset?a.dataset[Bh(b)]:a.getAttribute("data-"+b):null}
var Dh={};function Bh(a){return Dh[a]||(Dh[a]=String(a).replace(/\-([a-z])/g,function(b,c){return c.toUpperCase()}))}
;var Eh=/\.vflset|-vfl[a-zA-Z0-9_+=-]+/,Fh=/-[a-zA-Z]{2,3}_[a-zA-Z]{2,3}(?=(\/|$))/;function Gh(a,b,c){c=void 0===c?null:c;if(window.spf&&spf.script){c="";if(a){var d=a.indexOf("jsbin/"),e=a.lastIndexOf(".js"),f=d+6;-1<d&&-1<e&&e>f&&(c=a.substring(f,e),c=c.replace(Eh,""),c=c.replace(Fh,""),c=c.replace("debug-",""),c=c.replace("tracing-",""))}spf.script.load(a,c,b)}else Hh(a,b,c)}
function Hh(a,b,c){c=void 0===c?null:c;var d=Ih(a),e=document.getElementById(d),f=e&&Ch(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=Mf(d,b),b=""+Pa(b),Jh[b]=f),g||(e=Kh(a,d,function(){Ch(e,"loaded")||(Ah(e),Pf(d),U(Ua(Qf,d),0))},c)))}
function Kh(a,b,c,d){d=void 0===d?null:d;var e=Ec(document,"SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
...
function Lh(a){a=Ih(a);var b=document.getElementById(a);b&&(Qf(a),b.parentNode.removeChild(b))}
function Mh(a,b){if(a&&b){var c=""+Pa(b);(c=Jh[c])&&Of(c)}}
function Ih(a){var b=document.createElement("a");Tb(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+Wb(a)}
var Jh={};var Nh=[],Oh=!1;function Ph(){if("1"!=hb(we(),"args","privembed")){var a=function(){Oh=!0;"google_ad_status"in window?Q("DCLKSTAT",1):Q("DCLKSTAT",2)};
Gh("//static.doubleclick.net/instream/ad_status.js",a);Nh.push(Af(function(){Oh||"google_ad_status"in window||(Mh("//static.doubleclick.net/instream/ad_status.js",a),Oh=!0,Q("DCLKSTAT",3))},5E3))}}
function Qh(){return parseInt(R("DCLKSTAT",0),10)}
;function Rh(){this.g=!1;this.f=null}
Rh.prototype.initialize=function(a,b,c,d,e,f){var g=this;f=void 0===f?!1:f;b?(this.g=!0,Gh(b,function(){g.g=!1;window.botguard?Sh(g,c,d,f):(Lh(b),uh(new oh("Unable to load Botguard","from "+b)))},e)):a&&(eval(a),window.botguard?Sh(this,c,d,f):uh(Error("Unable to load Botguard from JS")))};
function Sh(a,b,c,d){if(d)try{a.f=new window.botguard.bg(b,c?function(){return c(b)}:Ia)}catch(e){uh(e)}else{try{a.f=new window.botguard.bg(b)}catch(e){uh(e)}c&&c(b)}}
Rh.prototype.dispose=function(){this.f=null};var Th=new Rh;function Uh(){return!!Th.f}
function Vh(a){a=void 0===a?{}:a;a=void 0===a?{}:a;return Th.f?Th.f.invoke(void 0,void 0,a):null}
;var Wh=D().toString();
function Xh(){a:{if(window.crypto&&window.crypto.getRandomValues)try{var a=Array(16),b=new Uint8Array(16);window.crypto.getRandomValues(b);for(var c=0;c<a.length;c++)a[c]=b[c];var d=a;break a}catch(e){}d=Array(16);for(a=0;16>a;a++){b=D();for(c=0;c<b%23;c++)d[a]=Math.random();d[a]=Math.floor(256*Math.random())}if(Wh)for(a=1,b=0;b<Wh.length;b++)d[a%16]=d[a%16]^d[(a-1)%16]/4^Wh.charCodeAt(b),a++}a=[];for(b=0;b<d.length;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b]&63));
return a.join("")}
;var Yh=y.ytLoggingDocDocumentNonce_||Xh();A("ytLoggingDocDocumentNonce_",Yh,void 0);var Zh=1;function $h(a){this.f=a}
$h.prototype.getAsJson=function(){var a={};void 0!==this.f.trackingParams?a.trackingParams=this.f.trackingParams:(a.veType=this.f.veType,void 0!==this.f.veCounter&&(a.veCounter=this.f.veCounter),void 0!==this.f.elementIndex&&(a.elementIndex=this.f.elementIndex));void 0!==this.f.dataElement&&(a.dataElement=this.f.dataElement.getAsJson());void 0!==this.f.youtubeData&&(a.youtubeData=this.f.youtubeData);return a};
$h.prototype.toString=function(){return JSON.stringify(this.getAsJson())};
$h.prototype.isClientVe=function(){return!this.f.trackingParams&&!!this.f.veType};function ai(a){a=void 0===a?0:a;return 0==a?"client-screen-nonce":"client-screen-nonce."+a}
function bi(a){a=void 0===a?0:a;return 0==a?"ROOT_VE_TYPE":"ROOT_VE_TYPE."+a}
function ci(a){return R(bi(void 0===a?0:a),void 0)}
A("yt_logging_screen.getRootVeType",ci,void 0);function di(){var a=ci(0),b;a?b=new $h({veType:a,youtubeData:void 0}):b=null;return b}
...
A("yt_logging_screen.getCurrentCsn",fi,void 0);function gi(a,b,c){var d=ei();(c=fi(c))&&delete d[c];b&&(d[a]=b)}
function hi(a){return ei()[a]}
A("yt_logging_screen.getCttAuthInfo",hi,void 0);function ii(a,b,c,d){c=void 0===c?0:c;if(a!==R(ai(c))||b!==R(bi(c)))if(gi(a,d,c),Q(ai(c),a),Q(bi(c),b),0==c||T("web_screen_associated_all_layers"))b=function(){setTimeout(function(){a&&ng("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:Yh,clientScreenNonce:a},ph)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b()}
A("yt_logging_screen.setCurrentScreen",ii,void 0);function ji(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=R("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=R("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=J(window.location.href);g&&f.push(g);g=J(d);if(0<=Za(f,g)||!g&&0==d.lastIndexOf("/",0))if(T("autoescape_tempdata_url")&&(f=document.createElement("a"),Tb(f,d),d=f.href),d){g=d.match(Xb);d=g[5];f=g[6];g=g[7];var k="";d&&(k+=d);f&&(k+="?"+f);g&&(k+="#"+g);d=k;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||b.ved)&&
(b=Object.assign({csn:fi()},b)),h){var h=parseInt(h,10);isFinite(h)&&0<h&&(e=b,b="ST-"+Wb(d).toString(36),e=e?$b(e):"",tg(b,e,h||5))}else h=b,e="ST-"+Wb(d).toString(36),h=h?$b(h):"",tg(e,h,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var m=void 0===m?"":m;var q=void 0===q?window:q;c=q.location;a=ac(a,l)+m;a=a instanceof H?a:Kb(a);c.href=Ib(a)}return!0}
;function ki(a,b){this.version=a;this.args=b}
;function li(a,b){this.topic=a;this.f=b}
li.prototype.toString=function(){return this.topic};var mi=B("ytPubsub2Pubsub2Instance")||new P;P.prototype.subscribe=P.prototype.subscribe;P.prototype.unsubscribeByKey=P.prototype.P;P.prototype.publish=P.prototype.O;P.prototype.clear=P.prototype.clear;A("ytPubsub2Pubsub2Instance",mi,void 0);var ni=B("ytPubsub2Pubsub2SubscribedKeys")||{};A("ytPubsub2Pubsub2SubscribedKeys",ni,void 0);var oi=B("ytPubsub2Pubsub2TopicToKeys")||{};A("ytPubsub2Pubsub2TopicToKeys",oi,void 0);var pi=B("ytPubsub2Pubsub2IsAsync")||{};A("ytPubsub2Pubsub2IsAsync",pi,void 0);
A("ytPubsub2Pubsub2SkipSubKey",null,void 0);function qi(a,b){var c=ri();c&&c.publish.call(c,a.toString(),a,b)}
function si(a){var b=ti,c=ri();if(!c)return 0;var d=c.subscribe(b.toString(),function(e,f){var g=B("ytPubsub2Pubsub2SkipSubKey");g&&g==d||(g=function(){if(ni[d])try{if(f&&b instanceof li&&b!=e)try{var k=b.f,h=f;if(!h.args||!h.version)throw Error("yt.pubsub2.Data.deserialize(): serializedData is incomplete.");try{if(!k.J){var l=new k;k.J=l.version}var m=k.J}catch(q){}if(!m||h.version!=m)throw Error("yt.pubsub2.Data.deserialize(): serializedData version is incompatible.");try{f=Reflect.construct(k,
eb(h.args))}catch(q){throw q.message="yt.pubsub2.Data.deserialize(): "+q.message,q;}}catch(q){throw q.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+q.message,q;}a.call(window,f)}catch(q){S(q)}},pi[b.toString()]?B("yt.scheduler.instance")?Af(g):U(g,0):g())});
...
return b}
function wi(a){var b=ri();b&&("number"===typeof a&&(a=[a]),G(a,function(c){b.unsubscribeByKey(c);delete ni[c]}))}
function ri(){return B("ytPubsub2Pubsub2Instance")}
;function xi(a){ki.call(this,1,arguments);this.csn=a}
v(xi,ki);var ti=new li("screen-created",xi),yi=[],zi=0;function Ai(a,b,c){var d=T("use_default_events_client")?void 0:ph;b={csn:a,parentVe:b.getAsJson(),childVes:ab(c,function(f){return f.getAsJson()})};
c=t(c);for(var e=c.next();!e.done;e=c.next())e=e.value.getAsJson(),(kb(e)||!e.trackingParams&&!e.veType)&&xh(Error("Child VE logged with no data"),"WARNING");c={fa:hi(a),S:a};"UNDEFINED_CSN"==a?Bi("visualElementAttached",b,c):d?ng("visualElementAttached",b,d,c):qh("visualElementAttached",b,c)}
function Bi(a,b,c){yi.push({payloadName:a,payload:b,options:c});zi||(zi=ui())}
function vi(a){if(yi){for(var b=t(yi),c=b.next();!c.done;c=b.next())c=c.value,c.payload&&(c.payload.csn=a.csn,ng(c.payloadName,c.payload,null,c.options));yi.length=0}zi=0}
;function Ci(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||nb(b);this.assets=a.assets||{};this.attrs=a.attrs||nb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
Ci.prototype.clone=function(){var a=new Ci,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==Ka(c)?a[b]=nb(c):a[b]=c}return a};function Di(){L.call(this);this.f=[]}
v(Di,L);Di.prototype.o=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.ub)}L.prototype.o.call(this)};var Ei=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Fi(a){a=a||"";if(window.spf){var b=a.match(Ei);spf.style.load(a,b?b[1]:"",void 0)}else Gi(a)}
function Gi(a){var b=Hi(a),c=document.getElementById(b),d=c&&Ch(c,"loaded");d||c&&!d||(c=Ii(a,b,function(){Ch(c,"loaded")||(Ah(c),Pf(b),U(Ua(Qf,b),0))}))}
function Ii(a,b,c){var d=document.createElement("link");d.id=b;d.onload=function(){c&&setTimeout(c,0)};
a=Ic(a);d.rel="stylesheet";d.href=wb(a).toString();(document.getElementsByTagName("head")[0]||document.body).appendChild(d);return d}
function Hi(a){var b=Ec(document,"A");Tb(b,new H(Gb,a));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Wb(a)}
;function Ji(a,b,c,d){L.call(this);var e=this;this.m=this.Z=a;this.W=b;this.u=!1;this.api={};this.X=this.G=null;this.H=new P;Pc(this,Ua(Qc,this.H));this.j={};this.T=this.Y=this.h=this.ea=this.f=null;this.K=!1;this.l=this.C=null;this.aa={};this.za=["onReady"];this.da=null;this.na=NaN;this.U={};this.i=d;Ki(this);this.ba("WATCH_LATER_VIDEO_ADDED",this.Ra.bind(this));this.ba("WATCH_LATER_VIDEO_REMOVED",this.Sa.bind(this));this.ba("onAdAnnounce",this.Ba.bind(this));this.Aa=new Di(this);Pc(this,Ua(Qc,this.Aa));
this.V=0;c?this.V=U(function(){e.loadNewVideoConfig(c)},0):d&&(Li(this),Mi(this))}
v(Ji,L);n=Ji.prototype;n.getId=function(){return this.W};
n.loadNewVideoConfig=function(a){if(!this.g){this.V&&(V(this.V),this.V=0);a instanceof Ci||(a=new Ci(a));this.ea=a;this.f=a.clone();Li(this);this.Y||(this.Y=Ni(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.m.style.width=Sc(Number(a)||a);if(a=this.f.attrs.height)this.m.style.height=Sc(Number(a)||a);Mi(this);this.u&&Oi(this)}};
function Li(a){var b;a.i?b=a.i.rootElementId:b=a.f.attrs.id;a.h=b||a.h;"video-player"==a.h&&(a.h=a.W,a.f.attrs.id=a.W);a.m.id==a.h&&(a.h+="-player",a.f.attrs.id=a.h)}
n.Fa=function(){return this.ea};
function Oi(a){a.f&&!a.f.loaded&&(a.f.loaded=!0,"0"!=a.f.args.autoplay?a.api.loadVideoByPlayerVars(a.f.args):a.api.cueVideoByPlayerVars(a.f.args))}
function Pi(a){var b=!0,c=Qi(a);c&&a.f&&(a=Ri(a),b=Ch(c,"version")===a);return b&&!!B("yt.player.Application.create")}
function Mi(a){if(!a.g&&!a.K){var b=Pi(a);if(b&&"html5"==(Qi(a)?"html5":null))a.T="html5",a.u||Si(a);else if(Ti(a),a.T="html5",b&&a.l)a.Z.appendChild(a.l),Si(a);else{a.f&&(a.f.loaded=!0);var c=!1;a.C=function(){c=!0;if(a.i)var d=a.i.serializedExperimentFlags;else a.f&&a.f.args&&(d=a.f.args.fflags);d="true"==Fe(d||"").player_bootstrap_method?B("yt.player.Application.createAlternate")||B("yt.player.Application.create"):B("yt.player.Application.create");var e=a.f?a.f.clone():void 0;d(a.Z,e,a.i);Si(a)};
a.K=!0;b?a.C():(Gh(Ri(a),a.C),(b=a.i?a.i.cssUrl:a.f.assets.css)&&Fi(b),Ui(a)&&!c&&A("yt.player.Application.create",null,void 0))}}}
function Qi(a){var b=Ac(a.h);!b&&a.m&&a.m.querySelector&&(b=a.m.querySelector("#"+a.h));return b}
function Si(a){if(!a.g){var b=Qi(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.K=!1,b.isNotServable&&a.f&&b.isNotServable(a.f.args.video_id)||Vi(a)):a.na=U(function(){Si(a)},50)}}
function Vi(a){Ki(a);a.u=!0;var b=Qi(a);b.addEventListener&&(a.G=Wi(a,b,"addEventListener"));b.removeEventListener&&(a.X=Wi(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.api[e]||(a.api[e]=Wi(a,b,e))}for(var f in a.j)a.G(f,a.j[f]);Oi(a);a.Y&&a.Y(a.api);a.H.O("onReady",a.api)}
function Wi(a,b,c){var d=b[c];return function(){try{return a.da=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.params=c,a.da=e,Ee(e))}}}
function Ki(a){a.u=!1;if(a.X)for(var b in a.j)a.X(b,a.j[b]);for(var c in a.U)V(parseInt(c,10));a.U={};a.G=null;a.X=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.ba.bind(a);a.api.removeEventListener=a.Wa.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.Ga.bind(a);a.api.getPlayerType=a.Ha.bind(a);a.api.getCurrentVideoConfig=a.Fa.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.Qa.bind(a)}
n.Qa=function(){return this.u};
n.ba=function(a,b){var c=this,d=Ni(this,b);if(d){if(!(0<=Za(this.za,a)||this.j[a])){var e=Xi(this,a);this.G&&this.G(a,e)}this.H.subscribe(a,d);"onReady"==a&&this.u&&U(function(){d(c.api)},0)}};
n.Wa=function(a,b){if(!this.g){var c=Ni(this,b);c&&de(this.H,a,c)}};
function Ni(a,b){var c=b;if("string"==typeof b){if(a.aa[b])return a.aa[b];c=function(){var d=B(b);d&&d.apply(y,arguments)};
a.aa[b]=c}return c?c:null}
function Xi(a,b){var c="ytPlayer"+b+a.W;a.j[b]=c;y[c]=function(d){var e=U(function(){if(!a.g){a.H.O(b,d);var f=a.U,g=String(e);g in f&&delete f[g]}},0);
lb(a.U,String(e))};
return c}
n.Ba=function(a){Pf("a11y-announce",a)};
n.Ra=function(a){Pf("WATCH_LATER_VIDEO_ADDED",a)};
n.Sa=function(a){Pf("WATCH_LATER_VIDEO_REMOVED",a)};
n.Ha=function(){return this.T||(Qi(this)?"html5":null)};
n.Ga=function(){return this.da};
function Ti(a){a.cancel();Ki(a);a.T=null;a.f&&(a.f.loaded=!1);var b=Qi(a);b&&(Pi(a)||!Ui(a)?a.l=b:(b&&b.destroy&&b.destroy(),a.l=null));for(a=a.Z;b=a.firstChild;)a.removeChild(b)}
n.cancel=function(){if(this.C){var a=Ri(this);Mh(a,this.C)}V(this.na);this.K=!1};
n.o=function(){Ti(this);if(this.l&&this.f&&this.l.destroy)try{this.l.destroy()}catch(b){S(b)}this.aa=null;for(var a in this.j)y[this.j[a]]=null;this.ea=this.f=this.api=null;delete this.Z;delete this.m;L.prototype.o.call(this)};
function Ui(a){return a.f&&a.f.args&&a.f.args.fflags?-1!=a.f.args.fflags.indexOf("player_destroy_old_version=true"):!1}
function Ri(a){return a.i?a.i.jsUrl:a.f.assets.js}
;var Yi={},Zi="player_uid_"+(1E9*Math.random()>>>0);function $i(a){delete Yi[a.getId()]}
...
function dj(a,b,c,d){if(Na(a)&&!Array.isArray(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16===a.length?b.list="PL"+a:b.playlist=a;return b}
;function ej(a){a=void 0===a?!1:a;L.call(this);this.f=new P(a);Pc(this,Ua(Qc,this.f))}
E(ej,L);ej.prototype.subscribe=function(a,b,c){return this.g?0:this.f.subscribe(a,b,c)};
...
v(fj,ej);function gj(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(Fd(a),d.i))}}
fj.prototype.o=function(){this.i=this.h=null;ej.prototype.o.call(this)};function hj(a){L.call(this);this.f=a;this.f.subscribe("command",this.xa,this);this.h={};this.j=!1}
v(hj,L);n=hj.prototype;n.start=function(){this.j||this.g||(this.j=!0,gj(this.f,"RECEIVING"))};
...
n.o=function(){var a=this.f;a.g||de(a.f,"command",this.xa,this);this.f=null;for(var b in this.h)ij(this,b);L.prototype.o.call(this)};function lj(a,b){hj.call(this,b);this.i=a;this.start()}
...
lj.prototype.o=function(){hj.prototype.o.call(this);delete this.i};function mj(a,b,c){L.call(this);var d=this;c=c||R("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.h=b||null;this.u="*";this.i=c;this.sessionId=null;this.channel="widget";this.C=!!a;this.m=function(e){a:if(!("*"!=d.i&&e.origin!=d.i||d.h&&e.source!=d.h||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.C&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
v(mj,L);mj.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=JSON.stringify(a);c.postMessage(d,this.u)}catch(e){Ee(e)}}};
mj.prototype.o=function(){window.removeEventListener("message",this.m);L.prototype.o.call(this)};function nj(){var a=this.g=new mj(!!R("WIDGET_ID_ENFORCE")),b=C(this.Va,this);a.j=b;a.l=null;this.g.channel="widget";if(a=R("WIDGET_ID"))this.g.sessionId=a;this.i=[];this.l=!1;this.j={}}
...
n.Ea=function(){this.l=!0;this.sendMessage("initialDelivery",this.ia());this.sendMessage("onReady");G(this.i,this.ya,this);this.i=[]};
...
this))}
v(qj,nj);n=qj.prototype;n.ta=function(a,b,c){if(this.f.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&aj(a)){var d=b;if(Na(d[0])&&!Array.isArray(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=cj.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=bj.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=dj.apply(window,d)}d=e}b.length=1;b[0]=d}this.f.handleExternalCall(a,b,c);aj(a)&&pj(this,this.ia())}};
...
n.Xa=function(){for(var a=this.f.getOptions(),b={namespaces:a},c=0,d=a.length;c<d;c++){var e=a[c],f=this.f.getOptions(e);b[e]={options:f};for(var g=0,k=f.length;g<k;g++){var h=f[g],l=this.f.getOption(e,h);b[e][h]=l}}this.sendMessage("apiInfoDelivery",b)};
...
n.dispose=function(){nj.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function rj(a,b,c){L.call(this);this.f=a;this.i=c;this.j=tf(window,"message",C(this.l,this));this.h=new fj(this,a,b);Pc(this,Ua(Qc,this.h))}
v(rj,L);rj.prototype.l=function(a){var b;if(b=!this.g)if(b=a.origin==this.i)a:{b=this.f;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,"string"===typeof b)){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.h,c.g||c.j("command",b.command,b.data,a.origin))}};
rj.prototype.o=function(){uf(this.j);this.f=null;L.prototype.o.call(this)};function sj(){var a=nb(tj),b;return Td(new O(function(c,d){a.onSuccess=function(e){Re(e)?c(e):d(new uj("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
v(uj,F);function vj(){this.g=0;this.f=null}
vj.prototype.then=function(a,b,c){return 1===this.g&&a?(a=a.call(c,this.f),Ld(a)?a:wj(a)):2===this.g&&b?(a=b.call(c,this.f),Ld(a)?a:xj(a)):this};
...
;function yj(a){F.call(this,a.message||a.description||a.name);this.isMissing=a instanceof zj;this.isTimeout=a instanceof uj&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Ud}
v(yj,F);yj.prototype.name="BiscottiError";function zj(){F.call(this,"Biscotti ID is missing from server")}
v(zj,F);zj.prototype.name="BiscottiMissingError";var tj={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Aj=null;
function ze(){if(T("disable_biscotti_fetch_on_html5_clients"))return Rd(Error("Fetching biscotti ID is disabled."));if(T("condition_biscotti_fetch_on_consent_cookie_html5_clients")&&!wc.get("CONSENT","").startsWith("YES+"))return Rd(Error("User has not consented - not fetching biscotti id."));if("1"===hb(we(),"args","privembed"))return Rd(Error("Biscotti ID is not available in private embed mode"));Aj||(Aj=Td(sj().then(Bj),function(a){return Cj(2,a)}));
return Aj}
function Bj(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new zj;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new zj;a=a.id;Ae(a);Aj=wj(a);Dj(18E5,2);return a}
function Cj(a,b){var c=new yj(b);Ae("");Aj=xj(c);0<a&&Dj(12E4,a-1);throw c;}
function Dj(a,b){U(function(){Td(sj().then(Bj,function(c){return Cj(b,c)}),Ia)},a)}
function Ej(){try{var a=B("yt.ads.biscotti.getId_");return a?a():ze()}catch(b){return Rd(b)}}
;function Fj(a){if("1"!==hb(we(),"args","privembed")){a&&ye();try{Ej().then(function(){},function(){}),U(Fj,18E5)}catch(b){S(b)}}}
;var Y=B("ytglobal.prefsUserPrefsPrefs_")||{};A("ytglobal.prefsUserPrefsPrefs_",Y,void 0);function Gj(){this.f=R("ALT_PREF_COOKIE_NAME","PREF");var a=wc.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Y[d]=c.toString())}}}
n=Gj.prototype;n.get=function(a,b){Hj(a);Ij(a);var c=void 0!==Y[a]?Y[a].toString():null;return null!=c?c:b?b:""};
n.set=function(a,b){Hj(a);Ij(a);if(null==b)throw Error("ExpectedNotNull");Y[a]=b.toString()};
n.remove=function(a){Hj(a);Ij(a);delete Y[a]};
...
function Jj(a){a=void 0!==Y[a]?Y[a].toString():null;return null!=a&&/^[A-Fa-f0-9]+$/.test(a)?parseInt(a,16):null}
Ja(Gj);function Kj(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];if(!Lj(a)||c.some(function(e){return!Lj(e)}))throw Error("Only objects may be merged.");
c=t(c);for(d=c.next();!d.done;d=c.next())Mj(a,d.value);return a}
function Mj(a,b){for(var c in b)if(Lj(b[c])){if(c in a&&!Lj(a[c]))throw Error("Cannot merge an object into a non-object.");c in a||(a[c]={});Mj(a[c],b[c])}else if(Nj(b[c])){if(c in a&&!Nj(a[c]))throw Error("Cannot merge an array into a non-array.");c in a||(a[c]=[]);Oj(a[c],b[c])}else a[c]=b[c];return a}
function Oj(a,b){for(var c=t(b),d=c.next();!d.done;d=c.next())d=d.value,Lj(d)?a.push(Mj({},d)):Nj(d)?a.push(Oj([],d)):a.push(d);return a}
function Lj(a){return"object"===typeof a&&!Array.isArray(a)}
function Nj(a){return"object"===typeof a&&Array.isArray(a)}
;function Pj(a,b){ki.call(this,1,arguments)}
v(Pj,ki);function Qj(a,b){ki.call(this,1,arguments)}
v(Qj,ki);var Rj=new li("aft-recorded",Pj),Sj=new li("timing-sent",Qj);var Tj=window;function Uj(){this.timing={};this.clearResourceTimings=function(){};
this.webkitClearResourceTimings=function(){};
this.mozClearResourceTimings=function(){};
this.msClearResourceTimings=function(){};
this.oClearResourceTimings=function(){}}
var Vj=Tj.performance||Tj.mozPerformance||Tj.msPerformance||Tj.webkitPerformance||new Uj;var Wj=!1;C(Vj.clearResourceTimings||Vj.webkitClearResourceTimings||Vj.mozClearResourceTimings||Vj.msClearResourceTimings||Vj.oClearResourceTimings||Ia,Vj);function Xj(a){var b=Yj(a);if(b.aft)return b.aft;a=R((a||"")+"TIMING_AFT_KEYS",["ol"]);for(var c=a.length,d=0;d<c;d++){var e=b[a[d]];if(e)return e}return NaN}
function Zj(a){var b;(b=B("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},Va("ytcsi."+(a||"")+"data_",b));return b}
function ak(a){a=Zj(a);a.info||(a.info={});return a.info}
function Yj(a){a=Zj(a);a.tick||(a.tick={});return a.tick}
function bk(a){var b=Zj(a).nonce;b||(b=Xh(),Zj(a).nonce=b);return b}
function ck(a){var b=Yj(a||""),c=Xj(a);c&&!Wj&&(qi(Rj,new Pj(Math.round(c-b._start),a)),Wj=!0)}
;function dk(){var a=B("ytcsi.debug");a||(a=[],A("ytcsi.debug",a,void 0),A("ytcsi.reference",{},void 0));return a}
function ek(a){a=a||"";var b=B("ytcsi.reference");b||(dk(),b=B("ytcsi.reference"));if(b[a])return b[a];var c=dk(),d={timerName:a,info:{},tick:{},span:{}};c.push(d);return b[a]=d}
;var fk=y.ytLoggingLatencyUsageStats_||{};A("ytLoggingLatencyUsageStats_",fk,void 0);function gk(){this.f=0}
function hk(){gk.f||(gk.f=new gk);return gk.f}
gk.prototype.tick=function(a,b,c){ik(this,"tick_"+a+"_"+b)||qh("latencyActionTicked",{tickName:a,clientActionNonce:b},{timestamp:c})};
gk.prototype.info=function(a,b){var c=Object.keys(a).join("");ik(this,"info_"+c+"_"+b)||(c=Object.assign({},a),c.clientActionNonce=b,qh("latencyActionInfo",c))};
gk.prototype.span=function(a,b){var c=Object.keys(a).join("");ik(this,"span_"+c+"_"+b)||(a.clientActionNonce=b,qh("latencyActionSpan",a))};
function ik(a,b){fk[b]=fk[b]||{count:0};var c=fk[b];c.count++;c.time=W();a.f||(a.f=yf(function(){var d=W(),e;for(e in fk)fk[e]&&6E4<d-fk[e].time&&delete fk[e];a&&(a.f=0)},5E3));
return 5<c.count?(6===c.count&&1>1E5*Math.random()&&(c=new oh("CSI data exceeded logging limit with key",b.split("_")),0<=b.indexOf("plev")||uh(c)),!0):!1}
...
function ok(a){return!!R("FORCE_CSI_ON_GEL",!1)||T("csi_on_gel")||!!Zj(a).useGel}
function pk(a){a=Zj(a);if(!("gel"in a))a.gel={gelTicks:{},gelInfos:{}};else if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}return a.gel}
;function qk(a,b,c){if(null!==b)if(ak(c)[a]=b,ok(c)){var d=b;b=pk(c);if(b.gelInfos)b.gelInfos["info_"+a]=!0;else{var e={};b.gelInfos=(e["info_"+a]=!0,e)}if(a.match("_rid")){var f=a.split("_rid")[0];a="REQUEST_ID"}if(a in jk){b=jk[a];0<=Za(kk,b)&&(d=!!d);a in mk&&"string"===typeof d&&(d=mk[a]+d.toUpperCase());a=d;d=b.split(".");for(var g=e={},k=0;k<d.length-1;k++){var h=d[k];g[h]={};g=g[h]}g[d[d.length-1]]="requestIds"===b?[{id:a,endpoint:f}]:a;f=Kj({},e)}else 0<=Za(nk,a)||uh(new oh("Unknown label logged with GEL CSI",
a)),f=void 0;f&&ok(c)&&(b=ek(c||""),Kj(b.info,f),b=pk(c),"gelInfos"in b||(b.gelInfos={}),Kj(b.gelInfos,f),c=bk(c),hk().info(f,c))}else ek(c||"").info[a]=b}
function rk(a,b,c){var d=Yj(c);if(T("use_first_tick")&&sk(a,c))return d[a];if(!b&&"_"!==a[0]){var e=a;Vj.mark&&(0==e.lastIndexOf("mark_",0)||(e="mark_"+e),c&&(e+=" ("+c+")"),Vj.mark(e))}e=b||W();d[a]=e;e=pk(c);e.gelTicks&&(e.gelTicks["tick_"+a]=!0);c||b||W();if(ok(c)){ek(c||"").tick[a]=b||W();e=bk(c);if("_start"===a){var f=hk();ik(f,"baseline_"+e)||qh("latencyActionBaselined",{clientActionNonce:e},{timestamp:b})}else hk().tick(a,e,b);ck(c);e=!0}else e=!1;if(!e){if(!B("yt.timing."+(c||"")+"pingSent_")&&
(f=R((c||"")+"TIMING_ACTION",void 0),e=Yj(c),B("ytglobal.timing"+(c||"")+"ready_")&&f&&sk("_start")&&Xj(c)))if(ck(c),c)tk(c);else{f=!0;var g=R("TIMING_WAIT",[]);if(g.length)for(var k=0,h=g.length;k<h;++k)if(!(g[k]in e)){f=!1;break}f&&tk(c)}ek(c||"").tick[a]=b||W()}return d[a]}
function sk(a,b){var c=Yj(b);return a in c}
function tk(a){if(!ok(a)){var b=Yj(a),c=ak(a),d=b._start,e=R("CSI_SERVICE_NAME","youtube"),f={v:2,s:e,action:R((a||"")+"TIMING_ACTION",void 0)},g=c.srt;void 0!==b.srt&&delete c.srt;b.aft=Xj(a);var k=Yj(a),h=k.pbr,l=k.vc;k=k.pbs;h&&l&&k&&h<l&&l<k&&ak(a).yt_pvis&&"youtube"===e&&(qk("yt_lt","hot_bg",a),e=b.vc,h=b.pbs,delete b.aft,c.aft=Math.round(h-e));for(var m in c)"_"!==m.charAt(0)&&(f[m]=c[m]);b.ps=W();m={};e=[];for(var q in b)"_"!==q.charAt(0)&&(h=Math.round(b[q]-d),m[q]=h,e.push(q+"."+h));f.rt=
e.join(",");b=!!c.ap;T("debug_csi_data")&&(c=B("yt.timing.csiData"),c||(c=[],Va("yt.timing.csiData",c)),c.push({page:location.href,time:new Date,args:f}));c="";for(var u in f)f.hasOwnProperty(u)&&(c+="&"+u+"="+f[u]);f="/csi_204?"+c.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var p=void 0===p?"":p;lf(f,p)||hf(f,void 0,void 0,void 0,p)}else hf(f);A("yt.timing."+(a||"")+"pingSent_",!0,void 0);qi(Sj,new Qj(m.aft+(Number(g)||0),a))}}
if(T("overwrite_polyfill_on_logging_lib_loaded")){var uk=window;uk.ytcsi&&(uk.ytcsi.info=qk,uk.ytcsi.tick=rk)};var vk=null,wk=null,xk=null,yk={};function zk(a){var b=a.id;a=a.ve_type;var c=Zh++;a=new $h({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});yk[b]=a;b=fi();c=di();b&&c&&Ai(b,c,[a])}
function Ak(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(ii(b,a),a=di()))for(var c in yk){var d=yk[c];d&&Ai(b,a,[d])}}
function Bk(a){yk[a.id]=new $h({trackingParams:a.tracking_params})}
function Ck(a){var b=fi(),c=yk[a.id];if(b&&c){a=T("use_default_events_client")?void 0:ph;var d="INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK";c={csn:b,ve:c.getAsJson(),gestureType:d};d={fa:hi(b),S:b};"UNDEFINED_CSN"==b?Bi("visualElementGestured",c,d):a?ng("visualElementGestured",c,a,d):qh("visualElementGestured",c,d)}}
function Dk(a){a=a.ids;var b=fi();if(b)for(var c=0;c<a.length;c++){var d=yk[a[c]];if(d){var e=b,f=T("use_default_events_client")?void 0:ph;d={csn:e,ve:d.getAsJson(),eventType:1};var g={fa:hi(e),S:e};"UNDEFINED_CSN"==e?Bi("visualElementShown",d,g):f?ng("visualElementShown",d,f,g):qh("visualElementShown",d,g)}}}
;A("yt.setConfig",Q,void 0);A("yt.config.set",Q,void 0);A("yt.setMsg",zh,void 0);A("yt.msgs.set",zh,void 0);A("yt.logging.errors.log",xh,void 0);
A("writeEmbed",function(){var a=R("PLAYER_CONFIG",void 0);Fj(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=R("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);R("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");b="player";var d=void 0===d?!0:d;b="string"===typeof b?Ac(b):b;var e=Zi+"_"+Pa(b),f=Yi[e];f&&d?a&&a.args&&a.args.fflags&&a.args.fflags.includes("web_player_remove_playerproxy=true")?f.api.loadVideoByPlayerVars(a.args||
null):f.loadNewVideoConfig(a):(f=new Ji(b,e,a,void 0),Yi[e]=f,Pf("player-added",f.api),Pc(f,Ua($i,f)));a=f.api;vk=a;a.addEventListener("onScreenChanged",Ak);a.addEventListener("onLogClientVeCreated",zk);a.addEventListener("onLogServerVeCreated",Bk);a.addEventListener("onLogVeClicked",Ck);a.addEventListener("onLogVesShown",Dk);d=R("POST_MESSAGE_ID","player");R("ENABLE_JS_API")?xk=new qj(a):R("ENABLE_POST_API")&&"string"===typeof d&&"string"===typeof c&&(wk=new rj(window.parent,d,c),xk=new lj(a,wk.h));
Ph()},void 0);
A("yt.www.watch.ads.restrictioncookie.spr",function(a){hf(a+"mac_204?action_fcts=1");return!0},void 0);
var Ek=De(function(){rk("ol");var a=Gj.getInstance(),b=!!((Jj("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&Dd(document.body,"exp-invert-logo"))if(c&&!Dd(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!Dd(d,"inverted-hdpi")){var e=Bd(d);Cd(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&Dd(document.body,"inverted-hdpi")&&Ed();b!=c&&(b="f"+(Math.floor(119/31)+1),d=Jj(b)||0,d=c?d|67108864:
d&-67108865,0==d?delete Y[b]:(c=d.toString(16),Y[b]=c.toString()),a.save())}),Fk=De(function(){var a=vk;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();R("PL_ATT")&&Th.dispose();a=0;for(var b=Nh.length;a<b;a++)Cf(Nh[a]);Nh.length=0;Lh("//static.doubleclick.net/instream/ad_status.js");Oh=!1;Q("DCLKSTAT",0);Rc(xk,wk);if(a=vk)a.removeEventListener("onScreenChanged",Ak),a.removeEventListener("onLogClientVeCreated",zk),a.removeEventListener("onLogServerVeCreated",Bk),a.removeEventListener("onLogVeClicked",Ck),a.removeEventListener("onLogVesShown",Dk),a.destroy();yk={}});
window.addEventListener?(window.addEventListener("load",Ek),window.addEventListener("unload",Fk)):window.attachEvent&&(window.attachEvent("onload",Ek),window.attachEvent("onunload",Fk));Va("yt.abuse.player.botguardInitialized",B("yt.abuse.player.botguardInitialized")||Uh);Va("yt.abuse.player.invokeBotguard",B("yt.abuse.player.invokeBotguard")||Vh);Va("yt.abuse.dclkstatus.checkDclkStatus",B("yt.abuse.dclkstatus.checkDclkStatus")||Qh);
Va("yt.player.exports.navigate",B("yt.player.exports.navigate")||ji);Va("yt.util.activity.init",B("yt.util.activity.init")||Ef);Va("yt.util.activity.getTimeSinceActive",B("yt.util.activity.getTimeSinceActive")||Hf);Va("yt.util.activity.setTimestamp",B("yt.util.activity.setTimestamp")||Ff);}).call(this);
